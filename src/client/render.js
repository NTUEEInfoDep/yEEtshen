...
const { PLAYER_RADIUS, PLAYER_MAX_HP, BULLET_RADIUS, MAP_SIZE, MONITOR_PIXEL_OFFSET, MONITOR_SIZE, MONITOR_MARGIN } = Constants;
...
function renderPlayerOnMonitor(x, y) {
  ...
  context.fillRect(canvasX, canvasY, MONITOR_PIXEL_OFFSET, MONITOR_PIXEL_OFFSET);
}
